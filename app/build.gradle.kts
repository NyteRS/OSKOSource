...
val packNPCDefinitionsFromDump = execTask("packNPCDefinitionsFromDump", "_nr_data") {
    mainClass.set("mgi.tools.parser.PackNPCDefinitionsFromDumpRunner")
    workingDir = file("../cache/") // adjust if needed
}
val packClientBackground = execTask("packClientBackground", "_nr_data") {
    mainClass.set("mgi.tools.parser.PackClientBackgroundRunner")
    // You can add args if needed, e.g. args = listOf(...)
    workingDir = file("../cache/") // or wherever your working directory should be
}
val packNPCDefinitions = execTask("packNPCDefinitions", "_nr_data") {
    mainClass.set("mgi.tools.parser.PackNPCDefinitionsRunner")
    workingDir = file("../cache/") // adjust if needed
}
