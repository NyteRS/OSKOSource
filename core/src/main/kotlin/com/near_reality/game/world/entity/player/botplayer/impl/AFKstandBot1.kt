...
class AFKstandBot1(s: String) : FakePlayer("PVMElijahh") { // Hardcoded Bot
...
// Equipment IDs
        val equipmentItems = mapOf(
            EquipmentSlot.WEAPON to 12006, // Dragon Scimitar
            EquipmentSlot.HELMET to 11865, // Helm of Neitiznot
...
// Debug bericht om te checken of skills correct worden ingesteld
        ...
        setLocation(Location(3092, 3495))
    ...
    fun startBot() {
        ...
        WorldTasksManager.schedule(1500) { // 1500 ticks = ongeveer 15 minuten
            ...
            val newX = 3092 + Utils.random(-3, 3)
            val newY = 3495 + Utils.random(-3, 3)
