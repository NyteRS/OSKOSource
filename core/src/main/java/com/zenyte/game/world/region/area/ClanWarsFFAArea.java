...
public class ClanWarsFFAArea extends PolygonRegionArea implements RandomEventRestrictionPlugin, DeathPlugin {
    ...
    public static void onServerLaunched(ServerLaunchEvent event) {
        ...
        World.spawnObject(new WorldObject(50081, 10, 0, new Location( 3089, 3498))); //pool
        World.spawnObject(new WorldObject(41724, 10, 2, new Location( 3078, 3489))); //clan hall portal
        World.spawnObject(new WorldObject(24911, 10, 0, new Location( 3098, 3512))); //altar spellbook
        World.spawnObject(new WorldObject(50082, 10, 0, new Location( 3087, 3504))); //teleporter
        World.spawnObject(new WorldObject(42834, 10, 0, new Location( 3097, 3514))); //bank chest
