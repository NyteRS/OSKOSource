...
//            }
        ...
        new Command(PlayerPrivilege.ADMINISTRATOR, "item", "Spawns an item in your inventory. If undefined, amount is set" +
                " to 1 " +
        ...
        new Command(PlayerPrivilege.ADMINISTRATOR, "itemn", "Displays a list of items that meet the requested name " +
                "criteria" +
                ". Argument: name", (p, args) -> {
            if(!(GameConstants.WORLD_PROFILE.isDevelopment()) && !p.getPrivilege().inherits(PlayerPrivilege.ADMINISTRATOR)) {
                p.sendMessage("You only have access to this command in beta worlds.");
                return;
            }
        ...
        new Command(PlayerPrivilege.ADMINISTRATOR, new String[]{"b", "bank"}, "Opens the bank.",
        ...
        new Command(PlayerPrivilege.PLAYER, "claimvotes", "Claims your votes for Defiance.", (p, args) -> {
