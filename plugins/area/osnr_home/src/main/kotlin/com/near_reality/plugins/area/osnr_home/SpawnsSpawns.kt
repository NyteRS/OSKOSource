...
class SpawnsSpawns : NPCSpawnsScript() {
	init {
		...
		//14900(3104, 3488, 0, WEST, 0)
		//KING_THOROS(3100, 3500, 0, EAST, 0)
		KRYSTILIA(3107, 3514, 0, EAST, 0)
		SHOP_KEEPER_2821(3079, 3511, 0, SOUTH, 1)
		HATIUS_COSAINTUS(3095, 3499, 0, SOUTH, 0)
//SHOP_ASSISTANT_2822(3087, 3506, 0, SOUTH, 1)
//AIVAS(3075, 3508, 0, EAST, 0)
//DHALIUS(3075, 3509, 0, EAST, 0)
		HERQUIN(3076, 3511, 0, EAST, 0)
		JOHN_16007(3076, 3510, 0, EAST, 0) // John
		BABA_YAGA(3076, 3509, 0, EAST, 0)
		FAE(3076, 3508, 0, EAST, 0)
		TRISTAN(3076, 3512, 0, EAST, 0)
//ARNAS(3076, 3512, 0, SOUTH, 0)
		BANKER_2117(3096, 3491, 0, WEST, 0)
		BANKER_2117(3096, 3489, 0, WEST, 0)
		...
		//GRAND_EXCHANGE_CLERK_2149(3088, 3501, 0, SOUTH_EAST, 0)
		//GRAND_EXCHANGE_CLERK_2151(3088, 3494, 0, NORTH_EAST, 0)
		CHALLENGE_HEADMASTER(3093, 3506, 0, SOUTH, 0)
//HEAD_CHEF(3094, 3462, 0, SOUTH, 2)
		HARI(3131, 3507, 0, SOUTH, 2)
		LESSER_FANATIC(3112, 3517, 0, SOUTH, 1)
		LUNA(3115, 3518, 0, SOUTH, 3)
		EMBLEM_TRADER(3093, 3514, 0, NORTH, 0)
		//EMBLEM_TRADER(3084, 3515, 0, NORTH, 0)
		ZAHUR(3084, 3512, 0, WEST, 0)
		16034(3084, 3511, 0, WEST, 0) // Primula
		//OZIACH(3103, 3513, 0, EAST, 0)
		NULODION(3092, 3467, 0, SOUTH, 1)
//TOOL_LEPRECHAUN(3107, 3498, 0, SOUTH, 1)
		...
		JOSSIK(3097, 3507, 0, NORTH, 0)
		//MAC(3077, 3495, 0, NORTH, 0)
		//WISE_OLD_MAN(3112, 3508, 0, NORTH, 0)
		IRON_MAN_TUTOR(3079, 3507, 0, NORTH, 0)
//7457(3078, 3512, 0, SOUTH, 0) // Perdu
		FRANK(3096, 3499, 0, SOUTH, 0)
		MAKEOVER_MAGE(3094, 3499, 0, SOUTH, 0)
		//GHOMMAL(3103, 3492, 0, SOUTH, 0)
		16065(3069, 3517, 0, WEST, 1) //hans
